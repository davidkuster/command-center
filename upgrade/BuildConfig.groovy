...
deploy {
    application {
        title = 'GrailsCommandCenter 0.1'
        vendor = System.properties['user.name']
        homepage = 'http://localhost/GrailsCommandCenter'
        description {
            complete = 'GrailsCommandCenter 0.1'
            oneline  = 'GrailsCommandCenter 0.1'
            minimal  = 'GrailsCommandCenter 0.1'
            tooltip  = 'GrailsCommandCenter 0.1'
        }
        icon {
            fallback {
...
app.fileType = '.groovy'
app.defaultPackageName = 'grailscommandcenter'
